...
function displayRandomNumber() {
	document.getElementById('targetNumber').textContent = State.randomNumber;
}

function displayCurrentTotal() {
	document.getElementById('currentTotal').textContent = State.currentTotal;
}
...
function checkGameStatus() {
	if (!State.newGame) {
		if (State.currentTotal === State.randomNumber) {
			...
			displayMessage(true);
			State.newGame = true;
		} else if (State.currentTotal > State.randomNumber) {
